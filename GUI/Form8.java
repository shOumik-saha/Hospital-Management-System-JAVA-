...
public class Form8 extends JFrame implements ActionListener
{
    ...
    public Form8()
    {
        ...
        l1 = new JLabel("MEDICINE SECTION");
        ...
        l2 = new JLabel("Name     Company         Expiry Date     Cost");
        ...
        l4 = new JLabel("Corex     Cino pvt         9-5-16            55");
        ...
        l5 = new JLabel("Nytra      Ace pvt         4-4-15            500");
        ...
        l6 = new JLabel("Brufa      Reckitt         12-7-17            50");
	    ...
	    l7 = new JLabel("Pride      DDF pvt         12-4-12            1100");

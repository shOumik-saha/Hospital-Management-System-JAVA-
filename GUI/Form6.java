...
public class Form6 extends JFrame implements ActionListener
{
    ...
    public Form6()
    {
        ...
        l2 = new JLabel("id         Name         Disease         Gender        Admit Status        Age");
        ...
        l4 = new JLabel("12         Pankaj        Cancer          Male           y                 30");
        ...
        l5 = new JLabel("13         Sumit          Cold           Male           y                 23");
        ...
        l6 = new JLabel("14         Alok         Maleriya         Male           y                 45");
	    ...
	    l7 = new JLabel("15         Ravi         Diabetes         Male           y                 25");

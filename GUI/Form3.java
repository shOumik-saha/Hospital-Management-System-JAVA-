...
public class Form3 extends JFrame implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent ae)
    {
        if(ae.getSource()==b1)
        {
			...
			String ds = JOptionPane.showInputDialog("Enter specialization");
			String dw = JOptionPane.showInputDialog("Enter Work Time");
			String dq = JOptionPane.showInputDialog("Enter Qualification");
			String dr = JOptionPane.showInputDialog("Enter Room No.");
